 ...
 * - Content elements: joinGroupButton, shareButton, aboutCard, imageCarousel, etc.
 * - Modal elements: shareModal, socialLinksModal, textModal
 * - Tab elements: aboutTab, eventsTab, resourcesTab, faqTab
 * - Actions: clickJoinGroup(), clickShare(), expandReduceText(), etc.
 */
export const newGroupAboutPage = (page: Page) => {
...
export type GroupAboutPage = ReturnType<typeof newGroupAboutPage>;
