...
/**
 * Component Object for Left Sidebar
 *
 * Function-based pattern for improved type inference and simpler usage.
 * Provides methods to interact with and verify the state of the left sidebar.
 */
export const newSidebarLeft = (page: Page) => {
  ...
  return {
    ...
    async mouseEnter(): Promise<void> {
      // Determine the width of the visible sidebar.
