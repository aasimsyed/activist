...
// The query resolves after the modal mounts, so the form is only rendered once
// the texts are here. Rendering earlier prefills it with blanks and submits
// against an undefined text id.
